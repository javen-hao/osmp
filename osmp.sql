...
-- Records of t_dict
-- ----------------------------
INSERT INTO `t_dict` VALUES ('0cf27351-1e37-419d-987d-d6a11de2a7c8', 'manager', '管理员', '2', 'test', 'id', 'name', '');
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES ('0cf81070-90ee-41d8-a82b-ca8337647868', 'admin', '827CCB0EEA8A706C4C34A16891F84E7B', '车龙泉', '砖夜攻城狮', '1', '2015-05-05 11:26:26', '2015-05-05 11:35:43', '10.34.43.59');
...
BEGIN
  ...
  DECLARE cur1 CURSOR FOR SELECT table_name from INFORMATION_SCHEMA.TABLES WHERE table_schema = 'java_platform';
